...
</html>`,b=e((e=>{var t=Symbol.for(`react.transitional.element`);function n(e,n,r){var i=null;if(r!==void 0&&(i=``+r),n.key!==void 0&&(i=``+n.key),`key`in n)for(var a in r={},n)a!==`key`&&(r[a]=n[a]);else r=n;return n=r.ref,{$$typeof:t,type:e,key:i,ref:n===void 0?null:n,props:r}}e.jsx=n})),x=e(((e,t)=>{t.exports=b()}))(),ee={hue:0,saturation:1,brightness:1},S={neon:{title:`Animated neon typography`,source:h,background:e=>e===`light`?`#f4f4f2`:`#090909`,targets:[{selector:`#board`,role:`ui`,width:`1040px`}],presentation:`animated-typography`},luminaWeaversCloth:{title:`Woven Cloth kinetic textile`,source:v,background:`#16090b`,targets:[{selector:`body > div.fixed.inset-0.overflow-hidden.z-0`,role:`background`}],presentation:`woven-cloth-label`},julianVanceNebula:{title:`Julian Vance nebula background`,source:g,background:`#09090b`,targets:[{selector:`#bg-canvas`,role:`background`}]},fluid:{title:`Aura UI fluid background`,source:m,background:`#030306`,targets:[{selector:`#bg-canvas`,role:`background`}]},nexusUnifiedFlow:{title:`Nexus unified halftone flow`,source:y,background:`#000000`,targets:[{selector:`#glcanvas`,role:`background`}]},emberStorm:{title:`Aeonix ember storm`,source:p,background:`#080503`,targets:[{selector:`#gl`,role:`background`}]},engravedCertificate:{title:`Kinetic Lathe certificate`,source:_,background:`#ded6c2`,targets:[{selector:`#cert`,role:`ui`,width:`720px`}]}};function C(e,t,n){return Math.min(n,Math.max(t,e))}function te(e,t,n){if(!e.includes(t))throw Error(`Neuform source adapter could not find: ${t}`);return e.replace(t,n)}function ne(e){return[[`return { t0: after + 5.6 + frnd() * 7.2, dur: total, segs: segs };`,`return { t0: after + 1.25 + frnd() * 1.75, dur: total, segs: segs };`],[`if (!ev) ev = nextEvent(4.2);`,`if (!ev) ev = nextEvent(0.55);`],[`cap = Math.min((W - W * 0.12) / blockW, (H - H * 0.18) / blockH);`,`cap = Math.min((W - W * 0.20) / blockW, (H - H * 0.28) / blockH);`],[`var y0 = (H - blockH * cap) * 0.48;`,`var y0 = (H - blockH * cap) / 2;`]].reduce((e,[t,n])=>te(e,t,n),e)}function re(e){return[[`x.fillText('L W', W/2, 190);`,`x.fillText('W C', W/2, 190);`],[`x.fillText('· KYOTO ·', W/2, 246);`,`x.fillText('· WOVEN CLOTH ·', W/2, 246);`],[`x.fillText('LUMINA', W/2, 400);`,`x.fillText('WOVEN', W/2, 400);`],[`x.fillText('WEAVERS', W/2, 520);`,`x.fillText('CLOTH', W/2, 520);`],[`x.fillText('K I N E T I C   T E X T I L E S   ·   2 0 2 4', W/2, 626);`,`x.fillText('T E X T I L E   S I M U L A T I O N', W/2, 626);`]].reduce((e,[t,n])=>te(e,t,n),e)}function w(e,t){return typeof e.background==`function`?e.background(t):e.background}function ie(e,t){let n=JSON.stringify(e.targets).replace(/</g,`\\u003c`),r=w(e,t),i=t===`light`?`grayscale(1) invert(1) contrast(1.08)`:`grayscale(1) contrast(1.08)`,a=`<style data-threeui-focus>
...
<\/script>`;return(e.presentation===`animated-typography`?ne(e.source):e.presentation===`woven-cloth-label`?re(e.source):e.source).replace(/<\/head>/i,`${a}</head>`).replace(/<\/body>/i,`${o}</body>`)}function ae({definition:e,mode:t=`dark`,hue:n=ee.hue,saturation:r=ee.saturation,brightness:i=ee.brightness,className:a,style:o}){let s=t===`light`?`light`:`dark`,c=w(e,s),l=(0,f.useMemo)(()=>ie(e,s),[e,s]),u=C(n,-180,180),d=C(r,0,2),p=C(i,.35,1.65),m=u===0&&d===1&&p===1?void 0:`hue-rotate(${u}deg) saturate(${d}) brightness(${p})`;return(0,x.jsx)(`iframe`,{className:a,"data-mode":s,title:e.title,srcDoc:l,sandbox:`allow-scripts`,loading:`eager`,style:{display:`block`,width:`100%`,height:`100%`,border:0,background:c,filter:m,...o}})}function oe(e){return function(t){return(0,x.jsx)(ae,{...t,definition:e})}}S.neon,S.luminaWeaversCloth,S.julianVanceNebula,S.fluid,S.nexusUnifiedFlow;var se=oe(S.emberStorm);S.engravedCertificate;var ce=e((e=>{var t=Symbol.for(`react.transitional.element`),n=Symbol.for(`react.fragment`);function r(e,n,r){var i=null;if(r!==void 0&&(i=``+r),n.key!==void 0&&(i=``+n.key),`key`in n)for(var a in r={},n)a!==`key`&&(r[a]=n[a]);else r=n;return n=r.ref,{$$typeof:t,type:e,key:i,ref:n===void 0?null:n,props:r}}e.Fragment=n,e.jsx=r,e.jsxs=r})),T=e(((e,t)=>{t.exports=ce()}))();function le(){return(0,T.jsx)(se,{className:`ember-bg`,style:{position:`fixed`,inset:0,width:`100%`,height:`100%`,zIndex:0,pointerEvents:`none`}})}function E({children:e,delay:t=0,className:n=``}){let r=(0,l.useRef)(null);return(0,l.useEffect)(()=>{let e=r.current;if(!e)return;let t=new IntersectionObserver(([n])=>{n.isIntersecting&&(e.classList.add(`rv-in`),t.disconnect())},{threshold:.1});return t.observe(e),()=>t.disconnect()},[]),(0,T.jsx)(`div`,{ref:r,className:`rv ${n}`,style:{transitionDelay:`${t}ms`},children:e})}function D(){let[e,t]=(0,l.useState)(!1),[n,r]=(0,l.useState)(!1),i=(0,l.useRef)(null);async function a(){let e=i.current?.value.trim()??``;if(!e||!e.includes(`@`)){r(!0),i.current?.classList.add(`shake`),setTimeout(()=>{r(!1),i.current?.classList.remove(`shake`)},600);return}try{await fetch(`https://formspree.io/f/mjybznyv`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({email:e})}),t(!0)}catch{r(!0),setTimeout(()=>r(!1),1500)}}return(0,T.jsxs)(T.Fragment,{children:[(0,T.jsx)(le,{}),(0,T.jsx)(`div`,{className:`grain`,"aria-hidden":`true`}),(0,T.jsx)(`div`,{className:`vignette`,"aria-hidden":`true`}),(0,T.jsx)(`div`,{className:`page`,children:(0,T.jsxs)(`div`,{className:`card`,children:[(0,T.jsx)(E,{className:`coin-anchor`,children:(0,T.jsxs)(`div`,{className:`coin`,children:[(0,T.jsxs)(`div`,{className:`coin-face`,children:[(0,T.jsx)(`span`,{className:`coin-letter`,children:`C`}),(0,T.jsx)(`div`,{className:`coin-specular`})]}),(0,T.jsx)(`div`,{className:`coin-rim`})]})}),(0,T.jsx)(E,{delay:200,children:(0,T.jsx)(`h1`,{className:`title`,children:`Advocate Not Adversary`})}),(0,T.jsx)(E,{delay:320,children:(0,T.jsx)(`p`,{className:`tagline golden-shine`,children:`Autism dad. Still learning.`})}),(0,T.jsx)(E,{delay:440,children:(0,T.jsx)(`p`,{className:`bio`,children:`When my son Jared was diagnosed, I didn't understand autism. I thought I'd failed him. I hadn't — I just had a lot to unlearn. This is what I've learned so far.`})}),(0,T.jsx)(E,{delay:560,className:`links-full`,children:(0,T.jsxs)(`div`,{className:`links`,children:[(0,T.jsxs)(`a`,{href:`https://chatgpt.com/g/g-6a8ab3434b6c8191961f1ba3d54f12d6-chris-advocate-not-adversary`,className:`cta cta-primary`,target:`_blank`,rel:`noopener noreferrer`,children:[(0,T.jsx)(`span`,{className:`cta-shimmer`,"aria-hidden":`true`}),(0,T.jsxs)(`span`,{className:`cta-content`,children:[(0,T.jsx)(`span`,{className:`cta-icon`,children:`💬`}),`Talk to Chris — Free AI Autism Dad`]})]}),(0,T.jsx)(`a`,{href:`https://www.etsy.com/listing/4563397685/iep-meeting-prep-toolkit-special`,className:`cta cta-ghost`,target:`_blank`,rel:`noopener noreferrer`,children:(0,T.jsxs)(`span`,{className:`cta-content`,children:[(0,T.jsx)(`span`,{className:`cta-icon`,children:`📄`}),`IEP Fight Kit — $17 on Etsy`]})}),(0,T.jsx)(`a`,{href:`https://www.tiktok.com/@advocatenotadversary`,className:`cta cta-ghost`,target:`_blank`,rel:`noopener noreferrer`,children:(0,T.jsxs)(`span`,{className:`cta-content`,children:[(0,T.jsx)(`span`,{className:`cta-icon`,children:`▶`}),`Follow on TikTok`]})})]})}),(0,T.jsx)(E,{delay:620,children:(0,T.jsxs)(`div`,{className:`shop-link`,children:[(0,T.jsx)(`p`,{className:`shop-desc`,children:`The tools I wish I had on the hardest days — planners built for families like ours.`}),(0,T.jsx)(`a`,{href:`https://steadyrootsshop.etsy.com`,target:`_blank`,rel:`noopener noreferrer`,children:`Steady Days on Etsy →`})]})}),(0,T.jsx)(E,{delay:660,children:(0,T.jsx)(`div`,{className:`email-section`,children:e?(0,T.jsxs)(`div`,{className:`downloads`,children:[(0,T.jsx)(`p`,{className:`downloads-heading`,children:`Here you go — two free tools, no strings.`}),(0,T.jsx)(`a`,{href:`/advocate-not-adversary/downloads/Does-This-Sound-Like-Your-Kid.pdf`,className:`download-link`,download:!0,children:`📋 AuDHD Signs Checklist`}),(0,T.jsx)(`a`,{href:`/advocate-not-adversary/downloads/Paycheck-Reality-Check.pdf`,className:`download-link`,download:!0,children:`💰 Paycheck Reality Check`}),(0,T.jsx)(`p`,{className:`downloads-note`,children:`Print them. Use them. They're yours.`})]}):(0,T.jsxs)(T.Fragment,{children:[(0,T.jsx)(`p`,{className:`email-label`,children:`Free printables — an AuDHD checklist and a budget worksheet. Drop your email.`}),(0,T.jsxs)(`div`,{className:`email-form`,children:[(0,T.jsx)(`input`,{ref:i,type:`email`,placeholder:`Your email`,autoComplete:`email`,className:n?`input-error`:``,onKeyDown:e=>{e.key===`Enter`&&a()}}),(0,T.jsx)(`button`,{type:`button`,onClick:a,children:`Send it`})]})]})})}),(0,T.jsx)(E,{delay:760,children:(0,T.jsx)(`div`,{className:`divider`})}),(0,T.jsx)(E,{delay:840,children:(0,T.jsxs)(`div`,{className:`pillars`,children:[(0,T.jsx)(`p`,{className:`golden-shine`,children:`"I am with you."`}),(0,T.jsx)(`p`,{className:`golden-shine`,children:`"Be their advocate, not their adversary."`})]})})]})})]})}(0,u.createRoot)(document.getElementById(`root`)).render((0,T.jsx)(l.StrictMode,{children:(0,T.jsx)(D,{})}));